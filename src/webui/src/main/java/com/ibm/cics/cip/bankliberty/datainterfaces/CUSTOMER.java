...
// Generated by IBM Record Generator for Java V3.0.3 Build 20250630-0857 on: Thu Feb 26 07:56:50 IST 2026
...
public class CUSTOMER {
	...
	*          07 CUSTOMER-FAMILY-NAME             PIC X(22). </pre> */
	...
	*          07 CUSTOMER-POSTCODE-OR-ZIP         PIC X(10). </pre> */
	...
	public CUSTOMER () {
		this.byteBuffer = new byte[CUSTOMER_RECORD_LEN];
	}
	...
	public String getCustomerTitle() {
		if (customerTitle == null) {
			customerTitle = CUSTOMER_TITLE.getString(byteBuffer);
		}
		return customerTitle;
	}

	public void setCustomerTitle(String customerTitle) {
		if (CUSTOMER_TITLE.equals(this.customerTitle, customerTitle)) {
			return;
		}
		CUSTOMER_TITLE.putString(customerTitle, byteBuffer);
